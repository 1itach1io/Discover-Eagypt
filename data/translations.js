// Translations Data - Global variable
var translations = {
  en: {
    nav: {
      home: "Home",
    ...
    tools: {
      title: "Tools",
      subtitle: "Explore our tourism tools"
    },
    hero: {
      title: "Plan Your Egypt Trip",
      subtitle: "Calculate your budget and explore 7000 years of history",
      cta: "Start Exploring"
    },
    stats: {
    ...
    plans: {
      title: "Travel Plans",
      subtitle: "Create your personalized trip",
      day: "day",
      days: "days",
      q1: {
        title: "How many days?"
    ...
    settings: {
      ...
      accessibility: {
        title: "Accessibility",
        desc: "Customize accessibility features",
        reducedMotion: "Reduce motion",
        highContrast: "High contrast mode"
      },
      about: {
        title: "About This Project",
        desc: "This is a OMAR web design project for a Middle 2 school competition. Built with HTML, CSS, and JavaScript to showcase Egypt's tourism attractions.",
        tech: "Technologies: HTML5, CSS3, Vanilla JavaScript"
      }
    },
    calculator: {
      title: "Calculate Your Trip Budget",
      subtitle: "Realistic travel cost estimation in Egypt - 27 Governorates",
      governorate: "Governorate",
      selectGovernorate: "-- Select Governorate --",
      days: "Number of Days",
      people: "Number of People",
      currency: "Currency",
      selectMessage: "Select a governorate to see the estimate",
      ...
      perDay: "Per day",
      disclaimer: "Prices are estimates and may vary by season and travel style",
      category: "Category"
    },
    footer: {
  ...
  ar: {
    nav: {
      ...
      nearbyPlaces: "الأماكن القريبه",
      exploreEgypt: "أستكشف مصر",
      map: "الخريطة",
      smartGuide: "المرشد الذكي",
      calculator: "حاسبة الميزانية",
      tools: "الأدوات",
      plans: "الخطط",
      search: "بحث"
    },
    search: {
      ...
      placeholder: "ابحث عن الأماكن والمدن...",
    ...
    tools: {
      title: "الأدوات",
      subtitle: "استكشف أدوات السياحة الخاصة بنا"
    },
    hero: {
      title: "خطط رحلتك لمصر",
      subtitle: "احسب ميزانيتك واستكشف 7000 عام من التاريخ",
      cta: "ابدأ الاستكشاف"
    },
    stats: {
    ...
    settings: {
      ...
      theme: {
        ...
        light: "الوضع الفاتح",
        dark: "الوضع الداكن",
        auto: "كشف مظهر الجهاز تلقائياً"
      },
      accessibility: {
        title: "إمكانية الوصول",
        desc: "خصص ميزات إمكانية الوصول",
    ...
    calculator: {
      title: "احسب ميزانية رحلتك",
      subtitle: "تقدير واقعي لتكاليف السفر داخل مصر - 27 محافظة",
      governorate: "المحافظة",
      selectGovernorate: "-- اختر المحافظة --",
      days: "عدد الأيام",
      people: "عدد الأشخاص",
      currency: "العملة",
      selectMessage: "اختر محافظة لرؤية التقدير",
      ...
      perPerson: "لكل شخص",
      perDay: "لكل يوم",
      disclaimer: "الأسعار تقديرية وقد تختلف حسب الموسم ونمط السفر",
      category: "الفئة"
    },
    footer: {
  ...
  fr: {
    nav: {
      ...
      exploreEgypt: "Explorez l'Egypte",
      map: "Carte",
      smartGuide: "Assistant intelligent",
      calculator: "Calculateur de budget",
      tools: "Outils",
      plans: "Plans",
      search: "Recherche"
    },
    search: {
      ...
      placeholder: "Rechercher des lieux, des villes...",
    ...
    tools: {
      title: "Outils",
      subtitle: "Explorez nos outils touristiques"
    },
    hero: {
      title: "Planifiez Votre Voyage en Égypte",
      subtitle: "Calculez votre budget et explorez 7000 ans d'histoire",
    ...
    plans: {
      ...
      subtitle: "Créez votre voyage personnalisé",
      day: "jour",
      days: "jours",
      q1: {
      ...
      result: {
        ...
        reason: "Pourquoi nous avons choisi ceci",
    ...
    settings: {
      ...
      theme: {
        ...
        light: "Mode clair",
        dark: "Mode sombre",
        auto: "Détecter automatiquement le thème de l'appareil"
      },
      accessibility: {
        title: "Accessibilité",
        desc: "Personnaliser les fonctionnalités d'accessibilité",
    ...
    calculator: {
      title: "Calculez votre budget de voyage",
      subtitle: "Estimation réaliste des coûts de voyage en Égypte - 27 gouvernorats",
      governorate: "Gouvernorat",
      selectGovernorate: "-- Sélectionnez un gouvernorat --",
      days: "Nombre de jours",
      people: "Nombre de personnes",
      currency: "Devise",
      selectMessage: "Sélectionnez un gouvernorat pour voir l'estimation",
      ...
      perDay: "Par jour",
      disclaimer: "Les prix sont estimatifs et peuvent varier selon la saison et le style de voyage",
      category: "Catégorie"
    },
    footer: {
